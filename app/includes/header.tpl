...
<header class="{{curNode.name}} {{curNode.service}} {{curNode.service}} nav-index-{{gService.currentTab}}" aria-label="header" ng-controller='tabsCtrl' >
  ...
  @@if (site === 'mew' ) {
    <div class="small announcement annoucement-warning">
      ...
      How do you avoid being the fool? Check the URL and look for a fat funfair.io Certificate up there. Look for https://mew.funfair.io/. <a href="https://myetherwallet.groovehq.com/knowledge_base/topics/protecting-yourself-and-your-funds" target="_blank" rel="noopener">Be safe &amp; secure</a>.</div>
    </div>
  }
  ...
  <section class="bg-gradient header-branding">
    <section class="container">
      @@if (site === 'mew' ) {
        <a class="brand" href="https://mew.funfair.io/" aria-label="Go to homepage">
